...
public class Player : MonoBehaviour, ICharacter
{
	...
	// private int fatigueDamageThisTurn = 0;
    ...
    /* TODO public void PlayASpellFromHand(CardLogic playedCard, ICharacter target)
    {
    ...
    public void HighlightPlayableCards(bool removeAllHighlights = false)
    {
        ...
        /* TODO foreach (CardLogic cl in hand.CardsInHand)
        {
